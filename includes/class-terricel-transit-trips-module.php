...
class Terricel_Transit_Trips_Module extends Terricel_Logistics_Module {
    ...
    private function get_google_distance_estimate($school_id, $destination) {
        ...
        return array(
            ...
            'route_options'   => $this->get_google_route_options($routes, $route, $buffer),
        );
    }
