...
class Terricel_Transit_Trips_Plugin {
    ...
    public function filter_report_types($types) {
        $types['trips_by_school'] = __('Trips by Organization', TERRICEL_TRANSIT_TRIPS_TEXT_DOMAIN);
        return $types;
    }
    ...
    public function filter_kiosk_dashboard_styles($styles, $dashboard) {
        ...
        return $styles
            ...
            . '.terricel-kiosk-dashboard[data-dashboard="trips"] .terricel-dispatch-day-count{font-size:24px;margin-top:8px}'
            . '.terricel-kiosk-dashboard[data-dashboard="trips"] .terricel-dispatch-items{gap:16px;padding:16px}'
            . '.terricel-kiosk-dashboard[data-dashboard="trips"] .terricel-dispatch-empty{font-size:24px;line-height:1.25}'
            . '.terricel-trip-monitor-item{border-left:7px solid #ffb84d;padding:18px}'
            . '.terricel-trip-monitor-item.has-vacancy{background:#4a1f25;border-color:#ef7777;border-left-color:#ef7777}'
            . '.terricel-trip-monitor-destination{font-size:30px;color:#fff;font-weight:900;line-height:1.08;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
            ...
            . '.terricel-trip-monitor-assignment{font-size:24px;color:#e6f0fb;line-height:1.14;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
            ...
            . '.terricel-dispatch-day[data-density="medium"] .terricel-trip-monitor-destination{font-size:26px}'
            . '.terricel-dispatch-day[data-density="medium"] .terricel-trip-monitor-time{font-size:24px}'
            . '.terricel-dispatch-day[data-density="medium"] .terricel-trip-monitor-meta{font-size:21px}'
            . '.terricel-dispatch-day[data-density="medium"] .terricel-trip-monitor-assignment{font-size:21px}'
    ...
    public function render_integrations_tab() {
        ...
        echo '<h2>' . esc_html__('Google Maps', TERRICEL_TRANSIT_TRIPS_TEXT_DOMAIN) . '</h2>';
        echo '<p><a class="button" href="' . esc_url('https://console.cloud.google.com/apis/credentials') . '" target="_blank" rel="noopener">' . esc_html__('Open Google Maps API Console', TERRICEL_TRANSIT_TRIPS_TEXT_DOMAIN) . '</a></p>';
    ...
    public function render_tools_tab_section() {
        ...
        echo '<p class="description">' . esc_html__('When enabled, Trip edit screens show the exact organization origin, destination, matching Google Maps link, and route alternatives returned by Google. Leave this off unless actively troubleshooting route estimate differences.', TERRICEL_TRANSIT_TRIPS_TEXT_DOMAIN) . '</p>';
