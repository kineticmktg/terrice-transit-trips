...
class Terricel_Transit_Trips_Plugin {
    ...
    public function filter_kiosk_dashboard_styles($styles, $dashboard) {
        ...
        return $styles
            ...
            . '.terricel-kiosk-dashboard[data-dashboard="trips"] .terricel-dispatch-day-count{font-size:22px;margin-top:8px}'
            . '.terricel-kiosk-dashboard[data-dashboard="trips"] .terricel-dispatch-items{gap:16px;padding:16px}'
            . '.terricel-kiosk-dashboard[data-dashboard="trips"] .terricel-dispatch-empty{font-size:22px;line-height:1.25}'
